...
1. **[`11-09-2026_TapNQue_Comprehensive_System_Guide_and_PhilSMS_Manual.docx`](docs/11-09-2026_TapNQue_Comprehensive_System_Guide_and_PhilSMS_Manual.docx)** / **[`.md`](docs/11-09-2026_TapNQue_Comprehensive_System_Guide_and_PhilSMS_Manual.md):** Complete operations manual, administrative credential guide, PhilSMS Cloud REST API v3 configuration, and pure software SMS simulation walkthrough.
